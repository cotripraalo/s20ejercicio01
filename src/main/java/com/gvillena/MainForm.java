...
public class MainForm extends javax.swing.JFrame {
    ...
    private void test() {
       ...
       //Declaracion de variables PlanPostPago
        PlanPostPago plan01;
        PlanPostPago plan02;
        PlanPostPago plan03;
                      
       // CLARO MAX 99 
        plan01 = new PlanPostPago(); // Inicializacion de variable
        plan01.setCodigoPlan("CMX99"); // Definicion de la propiedad codigo plan
        plan01.setNombrePlan("Claro MAX 99");// Definicion de la propiedad nombre plan al valor claro max 99 en una cadena o string 
